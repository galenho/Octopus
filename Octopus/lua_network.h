...
static const struct luaL_Reg lua_websocketclient_methods[] = {
	{ "connect", lua_websocketclient_connect },
	{ "send_msg", lua_websocketclient_sendmsg },
	{ "disconnect", lua_websocketclient_disconnect },
	{ "get_ip_address", lua_websocketclient_getipaddress },
	{ "__gc",  lua_websocketclient_destroy },
	{ NULL,NULL },
};

static const struct luaL_Reg lua_websocketclient_functions[] = {
	{ "new", lua_websocketclient_new },
	{ NULL, NULL }
};
