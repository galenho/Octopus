...
bool MongoDatabase::Initialize(const string uri, const string db_name, int32 conn_count)
{
...
void MongoDatabase::PushTask(MongoTask* task, int32 conn_idx)
{
...
void MongoDatabase::add_connect_ref( int32 conn_idx )
{
	imp_->add_connect_ref(conn_idx);
}

void MongoDatabase::remove_connect_ref( int32 conn_idx )
{
